...
export const PostDetail = () => {
  ...
  const metaKeywords = [parsedTagsStr, post.category, post.sub_category, 'VTV8.vn', 'Du lịch Việt Nam', post.title].filter(Boolean).join(', ');
  ...
  const newsSchema = {
    ...
    "author": [{
      "@type": "Organization",
      "name": post.company_name || "Hội viên VTV8.vn"
    }],
    "publisher": {
      "@type": "Organization",
      "name": "VTV8.vn",
