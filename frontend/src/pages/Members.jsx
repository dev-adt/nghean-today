  ...
  return (
    <div className="public-body">
      <SEOHead 
        ...
        description="Tra cứu và kết nối danh bạ hơn 500+ doanh nghiệp, đối tác uy tín hệ sinh thái VTV8.vn. Phân loại theo hạng Platinum, Gold, Silver."
        keywords="danh bạ doanh nghiệp, hội viên VTV8.vn, đối tác du lịch văn hóa, doanh nghiệp uy tín"
        url="/members"
      />
      <Navbar />
